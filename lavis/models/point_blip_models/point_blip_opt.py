...
from lavis.models.point_blip_models.point_blip import PointBlipBase, disabled_train
...
from lavis.models.point_blip_models.point_blip_qformer import cfg_from_yaml_file


@registry.register_model("point_blip_opt")
class PointBlipOPT(PointBlipBase):
    """
    BLIP2 OPT model.
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_opt2.7b": "configs/models/point_blip/point_blip_pretrain_opt2.7b.yaml",
        "caption_objaverse_opt2.7b": "configs/models/point_blip/point_blip_caption_opt2.7b.yaml",
    }
    ...
    def __init__(
        ...
        '''Point: PIT'''
        config_addr = './models_point/PointTransformer_8192point.yaml'
